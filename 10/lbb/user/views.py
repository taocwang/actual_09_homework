...
import log2db
import asset
from models import User,Asset2
...
def update_user():
    ...
    if _is_ok:
        User.validate_update(uid, username, password, age)
    return json.dumps({'is_ok':_is_ok, "error":_error})
