...
class User(object):
    ...
    def validate_login(cls,username,password):
        ...
        _cnt, _rt_list = MySQLConnection.execute_sql(_sql, (username, utils.md5_str(password)),fetch=True)
...
class Remote_cmd(object):
    ...
    @classmethod
    def ssh_execute(cls,host, username, password, port,cmds=[]):
        _rt_list = []
        #创建ssh连接对象
...
if __name__ == '__main__':
    ...
    print Remote_cmd.ssh_execute('42.62.70.74','root','1meWsgvYeSjMA0pecBMg',21860,['ls'])
